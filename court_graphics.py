...
def create_basketball_court(px, py, shots_list):
    """
    Disegna un campo da basket interattivo con Plotly.
    ...
    # Colore principale linee: Bianco (su sfondo scuro)
    ...
    # --- MIRINO ATTUALE (La stella gialla che si muove) ---
    ...
    # Clickmode='event+select' è FONDAMENTALE per catturare il tocco.
    # Dragmode=False impedisce lo spostamento dello sfondo.
    # Hovermode=False rimuove i fumetti fastidiosi durante il tocco.
    fig.update_layout(
